...
/* https://www.youtube.com/watch?v=6c1nCsbwUEk */
...
int main() {
	...
	/* it could get a little bit "salty" to pay later */
	array.elements = resize(&array, 3, EXPAND);

	fill(array.elements, START, array.size);
